...
import com.tapestry.javaapp.model.*;
import com.tapestry.javaapp.repository.*;
    ...
    private IssueResponse enrichIssueResponse(Issue issue) {
        ...
        if (issue.getAssigneeId() != null) {
            userRepository.findById(issue.getAssigneeId()).ifPresent(u ->
                    r.setAssignee(com.tapestry.javaapp.dto.response.UserResponse.from(u)));
        }
        if (issue.getReporterId() != null) {
            userRepository.findById(issue.getReporterId()).ifPresent(u ->
                    r.setReporter(com.tapestry.javaapp.dto.response.UserResponse.from(u)));
        }
